...
class _Home1State extends State<Moviee> {
    ...
    return Scaffold(appBar:AppBar(),
      body: Container(
        child: TinderSwapCard(
          ...
          totalNum: details.movieedetails.length,
          stackNum: 10,
          swipeEdge: 4.0,
          ...
          cardBuilder: (context, index) => Card(
            child: SingleChildScrollView(scrollDirection: Axis.vertical,
              child:   Column(crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  children:[  Center(child: Image.network(details.movieedetails[index].image)),
                    SizedBox(height: 20,),
                    Padding(
                      padding: const EdgeInsets.only(left: 3),
                      child: Text('${details.movieedetails[index].name}',style: TextStyle(fontSize: 26,fontWeight: FontWeight.w900),),
                    ),
                    SizedBox(height: 7,),
                    Padding(
                      padding: const EdgeInsets.only(left: 5),
                      child: Text(' Rating ${details.movieedetails[index].price}',style: TextStyle(fontSize: 13,fontWeight: FontWeight.w400),),
                    ),
