...
totalNum: details.morningdetails.length,
stackNum: 10,
swipeEdge: 4.0,
...
child: SingleChildScrollView(scrollDirection: Axis.vertical,
  ...
  children:[  Center(child: Image.network(details.morningdetails[index].image)),
      SizedBox(height: 20,),
      Padding(
        padding: const EdgeInsets.only(left: 3),
        child: Text('${details.morningdetails[index].name}',style: TextStyle(fontSize: 26,fontWeight: FontWeight.w900),),
      ),
      SizedBox(height: 7,),
      Padding(
        padding: const EdgeInsets.only(left: 5),
        child: Text(' Rs ${details.morningdetails[index].price}',style: TextStyle(fontSize: 13,fontWeight: FontWeight.w400),),
      ),
